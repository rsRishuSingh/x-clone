                ...
                props.data.map((element) => {
                    return (
                        <div className='post flex justify-center gap-x-1 mb-3 p-2 border-b-gray-700 border-b-[1px]' key={element.user_name} >
                            ...
                            <div className="user-img w-[10%]  flex justify-center items-start "><img className='rounded-full w-11 scale-110 lg:scale-100  cursor-pointer' src={element.profile_img} alt="" />
                            </div>
                            <div className="user-post sm:w-[80%] w-[90%] px-1">
                                <div className="user-name flex justify-between">
                                    <div className='name-details'>

                                        <span className='text-base font-bold sm:font-semibold cursor-pointer hover:underline'>{element.user_name}</span><span>
                                        ...
                                        <span className='text-gray-400 cursor-pointer '> {element.user_handle}</span>
                                ...
                                <div className="post-content my-1">
                                    <div className="post-content-para text-[15px] leading-tight sm:leading-normal">{element.post_content_para}</div>
