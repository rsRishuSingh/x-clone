...
export default function RightSection(props) {
    return (
        <div className='lg:w-[25vw] md:w-[36vw] bg-black  font-sans text-white max-w-[480px] hidden md:block'>
            <div className="fixed md:w-[36vw] lg:w-[25vw] max-w-[480px] flex flex-col items-center space-y-4 mt-2">
                <div className="searchBar lg:w-[25vw] md:w-[36vw] max-w-[480px] flex justify-center ">
